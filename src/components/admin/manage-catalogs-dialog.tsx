...
import { Book, Smartphone, Wifi, Map as MapIcon, Loader, Edit, Trash2, PlusCircle } from 'lucide-react';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '../ui/card';
import { getDeviceTypes, getLanguages, createLanguage, updateLanguage, deleteLanguage, type DeviceType, type Language } from '@/actions/catalogs';
