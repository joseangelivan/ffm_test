-- This script defines the schema for the Admins table.
-- It will be executed by the migration script.
...
-- Table for storing pins for the first login of an admin
...
-- Table for storing pins for email verification
