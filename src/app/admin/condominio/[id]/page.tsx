      ...
      <CardContent className="p-0">
        <div className="flex h-[70vh]">
            ...
            <div className="w-1/3 p-1 pl-0">
                <div className="relative border h-full rounded-md p-4 pt-2 bg-background">
                    <h2 className="text-base font-semibold tracking-tight px-2 absolute -top-3 left-4 bg-background">Módulos del Mapa</h2>
